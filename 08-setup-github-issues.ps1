...
Write-Host "   3. Authenticate:"
Write-Host "      - OAuth : sign in with your GitHub account (simplest)"
Write-Host "      - PAT   : classic PAT with 'repo' scope, OR"
Write-Host "                fine-grained PAT with 'Issues: Read and write'"
Write-Host "                scoped to: $GITHUB_REPO"
